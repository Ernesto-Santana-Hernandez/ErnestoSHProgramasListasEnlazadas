...
public class Principal 
{
 ...
 public static int leerEntero(String linea)
 {
  ...
  do{
   ...
   case 1:
   {
    int nuevo = Integer.parseInt(JOptionPane.showInputDialog(null,"Ingrese un número que desee ingresar a la lista:"));
    coleccion.agregarAlFinal(nuevo);
    break;
   }
   case 2:
   {
    JOptionPane.showMessageDialog(null, "La lista ingresada es: \n ");
    coleccion.imprimir();
    break;
   }
   case 3:
